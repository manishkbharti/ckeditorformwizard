...
$(document).ready(function () {
    if ($(".usertable").length > 0) {
        var e = {sPaginationType: "full_numbers", oLanguage: {sSearch: "<span>Search:</span> ", sInfo: "Showing <span>_START_</span> to <span>_END_</span> of <span>_TOTAL_</span> entries", sLengthMenu: "_MENU_ <span>entries per page</span>"}, sDom: "lfrtip", aoColumnDefs: [
            {bSortable: !1, aTargets: [0, 5]}
        ], oColVis: {buttonText: "Change columns <i class='icon-angle-down'></i>"}, oTableTools: {sSwfPath: "js/plugins/datatable/swf/copy_csv_xls_pdf.swf"}}, t = $(".usertable").dataTable(e);
    ...
    if ($("#flot-spider").length > 0) {
        ...
        c = [
            {label: "Pies", color: "green", data: r, spider: {show: !0, lineWidth: 12}},
            {label: "Apples", data: s, spider: {show: !0}},
            {label: "Cherries", data: o, spider: {show: !0}}
        ];
        $.plot($("#flot-spider"), c, {series: {spider: {active: !0, spiderSize: .8, legs: {data: [
            {label: "OEE"},
            {label: "MOE"},
            {label: "OER"},
            {label: "OEC"},
            {label: "Quality"}
        ], font: "14px Open Sans"}}}, grid: {mode: "spider"}})
    }
    if ($("#flot-radar").length > 0) {
        ...
        $.plot($("#flot-radar"), c, {series: {spider: {active: !0, spiderSize: .8, legs: {data: [
            {label: "OEE"},
            {label: "MOE"},
            {label: "OER"},
            {label: "OEC"},
            {label: "Quality"}
        ], font: "14px Open Sans"}}}, grid: {mode: "radar"}})
    }
    if ($("#flot-2").length > 0) {
        var a = [], f = [];
    ...
    if ($("#flot-5").length > 0) {
        ...
        for (var i = 0; i < h; i++)c[i] = {label: "Series" + (i + 1), data: Math.floor(Math.random() * 100) + 1};
    ...
    if ($("#flot-audience").length > 0) {
        ...
        $.plot($("#flot-audience"), [
            {label: "Visits", data: c, color: "#3a8ce5"}
    ...
    if ($("#flot-hdd").length > 0) {
        ...
        $.plot($("#flot-hdd"), [
            {label: "HDD usage", data: c, color: "#f36b6b"}
    ...
    if ($("#flot-cpu").length > 0) {
        ...
        $.plot($("#flot-cpu"), [
            {label: "CPU usage", data: c, color: "#74ad4b"}
        ], {xaxis: {min: (new Date("2013/03/30")).getTime(), max: (new Date("2013/03/31")).getTime(), mode: "time", tickSize: [3, "hour"]}, series: {lines: {show: !0, fill: !0}, points: {show: !0}}, grid: {hoverable: !0, clickable: !0}, legend: {show: !1}});
    ...
    var O = {id: "jQuery.PageGuide", title: "Take a quick tour of all the possibilities", steps: [
    ...
    ], R = $("#map3").gmap3({map: {options: {maxZoom: 14, zoom: 5}}, marker: {values: q, cluster: {radius: 100, events: {click: function (e) {
...
function getCalendarEvent(){
    $.ajax({
        ...
        data:"calendarId="+jQuery("#calenarSelect").val(),
